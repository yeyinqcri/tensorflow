 ...
 public:
  VifrtToIfrtTypeConverter() : VifrtTypeConverterBuiltin() {
    ...
    addConversion([&](VifrtArrayV1Type array) -> mlir::Type {
      ...
      auto layout_mode_attr =
          llvm::dyn_cast<mlir::StringAttr>(array.getLayoutModeAttr());
      if (layout_mode_attr && layout_mode_attr.str() == kVifrtDefaultString) {
        // No layout_mode was specified.
        layout_mode_attr = nullptr;
      }
