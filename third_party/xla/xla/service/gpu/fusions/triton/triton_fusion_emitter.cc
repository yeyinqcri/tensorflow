...
absl::Status EmitGeneric(mlir::OpBuilder builder,
  ...
  EmitterLocOpBuilder b(
      loc, builder,
      root->GetModule()->config().debug_options().xla_dump_emitter_loc());
...
absl::StatusOr<mlir::OwningOpRef<mlir::ModuleOp>> CreateTritonModule(
  ...
  EmitterLocOpBuilder b(loc, &mlir_context,
                        debug_options.xla_dump_emitter_loc());
  ...
  auto dump_triton_ir = [&]() {
    ...
    if (fusion->GetModule()->config().debug_options().xla_dump_emitter_loc()) {
