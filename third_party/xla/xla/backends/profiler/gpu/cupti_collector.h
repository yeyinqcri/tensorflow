...
// Same as CUDA 12.6.2 extras/CUPTI/samples/pm_sampling/pm_sampling.h to store
// the PM Sampling data.
struct SamplerRange {
  size_t range_index;
  uint64_t start_timestamp_ns;
  uint64_t end_timestamp_ns;
  // Change this map<std::string, double> to vector<double> to save memory.
